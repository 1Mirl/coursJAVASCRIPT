...
document.getElementById('p3').innerHTML = 'post-décrémenter // c contient '+ c +', là je post-décrémente de 1, c\'est toujours égal à '+ c-- + 'puis c\'est égal à '+ c +' aprés post-décrémentation.';
console.log(c);

document.getElementById('p4').innerHTML = 'pré-décrémenter // d contient la valeur '+ d +', là je pré-décrémente de 1, et donc d est à '+ --d;
console.log(d);
...
while (w1 < 15) {//tant que c'est vrai
    document.getElementById('while1').innerHTML += 'w1 contient la valeur ' + w1 + '<br>';//rajoute avec += la chaîne de caractère tant que la boucle n'est pas terminée
    //console.log(typeof w1, w1);
...
while (w2 < 10) {//tant que c'est vrai
    document.getElementById('while2').innerHTML += 'w2 contient la valeur ' + w2 + '<br>';//rajoute avec += la chaîne de caractère tant que la boucle n'est pas terminée
