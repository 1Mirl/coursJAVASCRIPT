// JS pour la page boucle - for

// alert('coucou');

for (let i= 0; i < 10; i++){ // for (1- initialisation de la variable; 2- test ou condition de sortie; 3- incrémentation)
    document.getElementById('p1').innerHTML += 'La variable i contient et est incrémentée : '+ i +' à chaque passage de boucles <br>';
    //console.log(i);
}
